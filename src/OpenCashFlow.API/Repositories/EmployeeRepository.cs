...
namespace OpenCashFlow.API.Repositories
{
    public class EmployeeRepository : IEmployeeRepository
    {
        ...
        //    //try
        //    //{
        //    //    config.AssertConfigurationIsValid(); // <-- this line tells you exactly WHERE it fails
        //    //}
        //    //catch (AutoMapperConfigurationException ex)
        //    //{
        //    //    Console.WriteLine(ex.Message);
        //    //    throw; // or log it better if you are in a web context
        //    //}
        ...
        public async Task CreateEmployeeAsync(Employee_Create_DTO employee, CancellationToken cancellationToken)
        {
            ...
            AspNetUserEntity.UserMustChangePassword = true; // force password change on first login
            await _context.AspNetUser_DS.AddAsync(AspNetUserEntity, cancellationToken);
        ...
        {
            // Retrieve salts and PIN hashes for active users in the company
            ...
            // Check on the client side if the hashed PIN matches
        ...
        public async Task UpdatePasswordAsync(Guid UserID, string newPassword, CancellationToken cancellationToken)
        {
            ...
            user.UserMustChangePassword = false; // remove the requirement after the change
            _context.AspNetUser_DS.Update(user);
            try
            {
                await _context.SaveChangesAsync(cancellationToken);
