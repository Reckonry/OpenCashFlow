...
namespace OpenCashFlow.Test.Tests
{
    ...
    public class LookupTests 
    {
        ...
        //todo: Insert [OK] with PaymentMethodName = "Bonifico" and visible
        ...
        //todo: Insert [FAIL] with PaymentMethodName = null (required field)
        [Trait("Layer", "Database")]
        [Trait("Feature", "PaymentMethod")]
        [Trait("Type", "Insert")]
        //[Fact(Skip = "WIP")] // TBF (to be fixed)
        ...
        public async Task Insert_PaymentMethod_When_NameIsNull()
        {
            ...
            var paymentMethod = new Payment_Method_LookUps
            {
                PaymentMethodName = null!, // Forced to test behavior with null
        ...
        //todo: Insert [FAIL] with duplicate PaymentMethodName for the same company
        [Trait("Layer", "Database")]
        [Trait("Feature", "PaymentMethod")]
        ...
        public async Task Insert_PaymentMethod_When_DuplicateNameInSameCompany()
        {
            ...
            {
                PaymentMethodName = "Carta", // same name
                PaymentMethodDescription = "Duplicato",
                TenantID = _context.Company_DS.First().TenantID,     // same company
                Visible = true,
                DateIns = DateTime.UtcNow
            };
        ...
        //todo: Insert [OK] with optional fields null (e.g., description)
        [Trait("Layer", "Database")]
        ...
        //todo: Insert [FAIL] with missing or non-existent TenantID
        [Trait("Layer", "Database")]
        [Trait("Feature", "DocumentType")]
        ...
        //todo: Insert [OK] with TenantID = null if it is a global lookup 
        [Trait("Layer", "Database")]
        [Trait("Feature", "DocumentType")]
        [Trait("Type", "Insert")]
        //[Fact(Skip = "WIP")] // TBF (to be fixed)
        ...
        //todo: SoftDelete [OK] sets IsDeleted = true without removing 
        [Trait("Layer", "Database")]
        [Trait("Feature", "PaymentMethod")]
        ...
        //todo: Visibility [OK] only records with Visible = true returned by standard query

        //todo: Update [OK] changes method name/metadata
        [Trait("Layer", "Database")]
        [Trait("Feature", "PaymentMethod")]
        [Trait("Type", "Query")]
        //[Fact(Skip = "WIP")] // TBF (to be fixed)
        ...
        //todo: Delete [FAIL] if method is linked to payments (FK constraint)
        [Trait("Layer", "Database")]
        [Trait("Feature", "PaymentMethod")]
        [Trait("Type", "Constraint")]
        //[Fact(Skip = "WIP")] // TBF (to be fixed)
        ...
        //todo: Insert [OK] with DocumentTypeName = "Invoice"
        [Trait("Layer", "Database")]
        [Trait("Feature", "DocumentType")]
        [Trait("Type", "Insert")]
        ...
        //todo: Insert [FAIL] with DocumentTypeName null
        [Trait("Layer", "Database")]
        [Trait("Feature", "DocumentType")]
        ...
        public async Task Insert_DocumentType_WithNullName_ShouldFail()
        {
            ...
            var docType = new Payment_DocumentType_LookUp
            {
                DocumentTypeName = null!, // Forced to simulate incorrect behavior
                Visible = true,
                DateIns = DateTime.UtcNow
            };
        ...
        //todo: Insert [FAIL] with duplicate in the same company    
        [Trait("Layer", "Database")]
        [Trait("Feature", "DocumentType")]
        [Trait("Feature", "Company")]
        [Trait("Type", "Insert")]
        ...
        public async Task Insert_DocumentType_DuplicateNameForSameCompany_ShouldFail()
        {
            ...
            {
                DocumentTypeName = "Fattura", // same name
                TenantID = _context.Company_DS.First().TenantID,      // same company
                Visible = true,
                DateIns = DateTime.UtcNow
            };
        ...
        //todo: Insert [OK] across multiple companies
        [Trait("Layer", "Database")]
        [Trait("Feature", "DocumentType")]
        [Trait("Feature", "Company")]
        [Trait("Type", "Insert")]
        ...
        public async Task Insert_DocumentType_SameNameAcrossDifferentCompanies_ShouldSucceed()
        {
            ...
            {
                DocumentTypeName = "Fattura", // same name
                TenantID = _context.Company_DS.Skip(1).First().TenantID,       // different company
                Visible = true,
                DateIns = DateTime.UtcNow
            };
        ...
        //todo: FK [FAIL] delete if used in payments
        [Trait("Layer", "Database")]
        [Trait("Feature", "DocumentType")]
        [Trait("Feature", "Company")]
        [Trait("Type", "Delete")]
