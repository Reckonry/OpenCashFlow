...
public class AuditLogController : Controller
{
    ...
    public async Task<IActionResult> Index([FromQuery] AuditLog_Filter_DTO? filters)
    {
        ...
        {
            TempData["Error"] = response.Message ?? "Impossibile recuperare i log.";
        ...
        catch (Exception ex)
        {
            ...
            TempData["Error"] = "Risposta non valida dal servizio audit log.";
        }
    ...
    public async Task<IActionResult> Details(Guid id)
    {
        ...
        if (!response.Success || response.Data is null)
        {
            TempData["Error"] = response.Message ?? "Log non trovato.";
    ...
    public async Task<IActionResult> Export([FromQuery] AuditLog_Filter_DTO? filters)
    {
        ...
        {
            TempData["Error"] = exportResult.Message ?? "Impossibile esportare l'audit log.";
