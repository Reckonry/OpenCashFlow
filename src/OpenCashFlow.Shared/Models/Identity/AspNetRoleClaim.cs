...
namespace Shared.Models.Identity
{
    ...
    public class AspNetRoleClaim
    {
        ...
        [Required, NotNull, Column(Order = 1), ForeignKey("RoleID")]
        public Guid RoleID { get; set; }

        [Column(TypeName = "text", Order = 2), Display(Name = "Claim Type")]
        public required string ClaimType { get; set; }

        [Column(TypeName = "text", Order = 3), Display(Name = "Claim Value")]
