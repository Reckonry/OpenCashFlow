...
namespace Shared.DTOs
{
    public class Company_Detail_DTO
    {
        ...
        /// </summary>
        public List<Company_Address>? CompanyAddresses { get; set; }

        /// <summary>
        /// lista di numeri di tel (se presente).
        /// </summary>
        public List<Company_Contact_Phone>? CompanyPhones { get; set; }

        /// <summary>
        /// lista di Indirizzi email (se presente).
        /// </summary>
        public List<Company_Contact_Email>? CompanyEmails { get; set; }
        ...
        public List<Company_BillingAddress>? BillingDetails { get; set; }
