...
namespace OpenCashFlow.App.Controllers
{
    public partial class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Register([Bind] Register_DTO registration)
        {
            ...
            {
                ModelState.AddModelError(nameof(registration.AcceptPrivacyPolicy), "Devi accettare la privacy policy.");
            }
        ...
        public async Task<IActionResult> ConfirmAccount(Guid TenantID, Guid UserID)
        {
            ...
            //if (result == true)
            return RedirectToAction("Login"); //todo: aggiungere messaggio di conferma avvenuta
        }
    }
}
