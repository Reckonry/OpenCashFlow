# Gestione Incassi - Development Documentation Navigator

**Project**: Multi-tenant SaaS platform for payment tracking and cash flow management
**Tech Stack**: .NET 9, ASP.NET Core, PostgreSQL, Entity Framework Core, SignalR
**Updated**: 2025-10-13
