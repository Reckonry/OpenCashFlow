...
namespace OpenCashFlow.Contracts.DTOs.Employees
{
    public class Employee_Update_DTO
    {
        ...
        // Single role selection during update (optional)
        public Guid? SelectedRoleID { get; set; }

        #region User privileges
        /// <summary> Role IDs to assign to the user (multi-role)</summary>
        public ICollection<Guid> RoleIDs { get; set; } = new List<Guid>();

        /// <summary> connected roles applied to the user (read-only for views) </summary>
        public ICollection<EmployeeRoleDto> Roles { get; set; } = new List<EmployeeRoleDto>();

        /// <summary> Allowed privileges </summary>
        public ICollection<EmployeeUserPermissionDto> AssignedPermissions { get; set; } = new List<EmployeeUserPermissionDto>();

        /// <summary> Denied privileges </summary>
        public ICollection<EmployeeUserDeniedPermissionDto> DeniedPermissions { get; set; } = new List<EmployeeUserDeniedPermissionDto>();
        ...
        public string? TmpPasswordRepeat { get; set; }
