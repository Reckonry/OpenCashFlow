...
namespace OpenCashFlow.Test.Tests
{
    ...
    public class RegistrationApiTests
    {
        ...
        //todo: Registrazione [OK] (utente valido, dati corretti, company esistente e attiva)
        [Trait("Layer", "API")]
        ...
        //todo: Registrazione [FAIL] (email già esistente)
        [Trait("Layer", "API")]
        [Trait("Feature", "Registration")]
        [Trait("Type", "Security")]
        [Trait("Priority", "High")]
        ...
        //todo: Registrazione [FAIL] (campi obbligatori mancanti: email, password, company ID)
        [Trait("Layer", "API")]
        [Trait("Feature", "Registration")]
        ...
        //todo: Registrazione [FAIL] (formato email non valido)               
        [Trait("Layer", "API")]
        [Trait("Feature", "Registration")]
        [Trait("Type", "Validation")]
        [Trait("Priority", "Medium")]
        ...
        //todo: Registrazione [OK] (auditing: traccia utente creato, IP, data/ora)
        [Trait("Layer", "API")]
        [Trait("Feature", "Registration")]
        [Trait("Type", "Integration")]
        [Trait("Priority", "High")]
