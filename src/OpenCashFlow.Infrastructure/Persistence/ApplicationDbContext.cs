...
using OpenCashFlow.Infrastructure.Persistence.Entities.Stripe;
using System;
using System.Collections.Generic;
using System.Diagnostics.Metrics;
using System.Reflection.Emit;
using static OpenCashFlow.Infrastructure.Logging.LogEvents;
...
namespace OpenCashFlow.Infrastructure.Persistence
{
    public class ApplicationDbContext : DbContext
    {
        ...
        #region Admin
        public DbSet<OpenCashFlow.Infrastructure.Persistence.Entities.Admin.Admin_AuditLog> Admin_AuditLog_DS { get; set; }
        #endregion

        #region Cash
        public DbSet<OpenCashFlow.Infrastructure.Persistence.Entities.Cash.CashBalance> CashBalances { get; set; } = default!;
        public DbSet<OpenCashFlow.Infrastructure.Persistence.Entities.Cash.CashLedger> CashLedgers { get; set; } = default!;
        #endregion
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OpenCashFlow.Infrastructure.Persistence.Entities.Cash.CashBalance>(b =>
            {
            ...
            modelBuilder.Entity<OpenCashFlow.Infrastructure.Persistence.Entities.Cash.CashLedger>(b =>
            {
