...
namespace OpenCashFlow.Shared.Mappings
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<Payment, Payment_Create_DTO>()
                // mapping espliciti quando il nome delle proprietà differisce
                .ForMember(dest => dest.EmployeeFullName,
                           opt => opt.MapFrom(src => src.User!.EmployeeSurnameName));
            ...
            CreateMap<global::Shared.Models.Identity.AspNetRole, global::Shared.DTOs.Identity.Role_List_DTO>()
