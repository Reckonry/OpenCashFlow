...
{
    [Table(name: "Companies_Contacts_Phones")]
    [PrimaryKey(nameof(ContactPhoneID))]
    public class Company_Contact_Phone
    {
        #region Data Linking
        ...
        [AllowNull, Column(TypeName = "varchar(100)", Order = 10), Display(Name = "Prefix Code")]
        public string? CountryPrefixCode { get; set; }

        [AllowNull, Column(TypeName = "varchar(256)", Order = 11), Display(Name = "Phone")]
        ...
        [AllowNull, Column(TypeName = "boolean", Order = 51), Display(Name = "Phone Confirmed")]
        public bool PhoneConfirmed { get; set; } = false;

        [NotMapped]
        public string? FullPhone { get => CountryPrefixCode + " " + Phone; }
